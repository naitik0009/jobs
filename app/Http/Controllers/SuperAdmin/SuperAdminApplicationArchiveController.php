...
class SuperAdminApplicationArchiveController extends SuperAdminBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('super-admin.applications-archive.index', $this->data);
    }
...
// dd($jobApplications);
    ...
    public function show($id)
    {
        ...
        $view = view('super-admin.applications-archive.show', $this->data)->render();
